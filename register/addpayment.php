...
<div class="wrapper">
          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="addpayment.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Add New</p>
                    </a>
                  </li>
  ...
  <div class="content-wrapper">
    ...
    <?php }
          ?>
            <div class="container">
                <h4 class="text-normal mb-2" style="font-size: 16px;text-transform: uppercase;">Add New Payment</h4>
                <div class="form-group">
                    <form action="../include/register/addpayment.php" method="post">
                        <div class="container mb-2">
                            <label class="form-label">Patient Fullname</label>
                            <input type="text" name="p_name" class="form-control" placeholder="Enter Patient Fullname">
                        </div>
                        <div class="container mb-2">
                        ...
                        <div class="container mb-2">
                            ...
                            <select class="form-select" aria-label="Default select example" name="doctor_name">
                                ...
                                <option value="doctor2">Docotor 2</option>
                              </select>                        
                            </div>
                        <div class="container mb-2">
                            <label class="form-label">Department  Name</label>
                            <select class="form-select" aria-label="Default select example" name="dept_name">
                        ...
                        <div class="container mb-2">
                            ...
                            <select class="form-select" aria-label="Default select example" name="payment_type">
                                ...
                                <option value="laboratory And Pharmacy">laboratory And Pharmacy</option>
                              </select>                         </div>
                        <div class="container mb-2">
                            <label class="form-label">Payment Amount</label>
                            <input type="text"  class="form-control" placeholder="Payment Amount" name="payment_amount">
                        </div>
                        <div class="container mb-2">
