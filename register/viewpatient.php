        ...
        <div class="row">
            <div class="container">
              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h4 class="mb-2">List of Patient</h4>
                    <ul class="nav navbar-right panel_toolbox mb-2 mt-2">
                    <a href="addnewpatient.php" class="btn btn-sm btn-info text-white "><i class="fa fa-plus"></i> Add Patient</a>
                    </ul>
                  ...
                  <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                          ...
                          ?>
                            ...
                            <td style="font-size:14px;"><?php echo $row["p_address"]; ?></td>
                            <td style="font-size:14px;"><?php echo $row["p_age"]; ?></td>
                            <td style="font-size:14px;"><?php echo $row["p_gender"]; ?></td>
                            <td style="font-size:14px;"><?php echo $row["p_ailment"]; ?></td>
                            <td style="font-size:14px;"><?php echo $row["p_fee"]; ?></td>
                            <td style="font-size:14px;"><?php echo $row["p_entered_date"]; ?></td>
                            <td style="font-size:14px;"><?php echo $row["p_leaving_date"]; ?></td>
                            <td>
                                <a href="edit-patient.php?display=<?php echo $row['id']?>" class="btn btn-sm btn-success text-white mb-2"style="text-transform:capitalize;"><i class="fa fa-edit"></i> edit</a>
                                <a href="viewpatient.php?del=<?php echo $del;?>" class="btn btn-sm btn-danger text-white"style="text-transform:capitalize;"><i class="fa fa-trash"></i> delete</a>
                              </td>
                          </tr>
                          <?php
                            } ?>
