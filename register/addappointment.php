...
<div class="wrapper">
          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="addappointment.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Add New</p>
                    </a>
                  </li>
  ...
  <div class="content-wrapper">
    ...
    <?php }else if(isset($_GET['inputerror'])){?>
      <p class='bg-danger text-white p-2'><i class='fa fa-exclamation'></i> Empty Field Please Fill The Form Fields</p>

      
      <?php } ?>
            <div class="container">
                <h4 class="text-normal mb-2" style="font-size: 16px;text-transform: uppercase;">Add New Appointment</h4>
                <div class="form-group">
                    <form action="../include/register/addappointment.php"method="post"class="bg-white p-4">
