          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="addnewpatient.php" class="nav-link active">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          if(isset($_GET['success'])){?>
            <p class='bg-success text-white p-2'><i class='fa fa-check'></i> New Patient Added Successfully</p>
            <?php     }else if(isset($_GET['error'])){?>
              
              <p class='bg-danger text-white p-2'><i class='fa fa-exclamation'></i> Failed To Add New Patient</p>
    <?php }else if(isset($_GET['inputerror'])){?>
      <p class='bg-danger text-white p-2'><i class='fa fa-exclamation'></i>Empty Field Please Fill The Form Below</p>

      <?php } ?>
            <div class="container">
                <h4 class="text-normal mb-2">Add New Patient</h4>
                <div class="form-group">
                    <form action="../include/register/addnewpatient.php" method="post">
                        <div class="container mb-2">
                            <label class="form-label">Patient Fullname</label>
                            <input type="text" name="p_fname" class="form-control" placeholder="Enter Patient Fullname">
                        </div>
                        <div class="container mb-2">
                        ...
                        <div class="container mb-2">
                            ...
                            <input type="text" name="p_address" class="form-control" placeholder="Enter Patient Address">
                        </div>
                        <div class="container mb-2">
                        ...
                        <div class="container mb-2">
                            ...
                            <select class="form-select" aria-label="Default select example" name="p_gender">
                        ...
                        <div class="container mb-2">
                            ...
                            <input type="text" name="p_fee" class="form-control" placeholder="Enter Patient Fee">            
                         </div>
                         <div class="container mb-1">
                            <label class="form-label">Patient Entered Date</label>
                            <input type="date" name="entered_date" class="form-control">
                         </div>
                         <div class="container mb-1">
