...
if(isset($_POST['submit'])){
    ...
    $date = $_POST['date'];
    $sql = "UPDATE department SET dept_name = '$dept_name', created_date = '$date' where id  = '$id'";
    $result = mysqli_query($connect,$sql);
    if($result){
        header('location:viewdepartment.php?success');
        exit();
    }
    else{
        header('location:viewdepartment.php?error');
        exit();
    }
}
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php echo $row['img'];?></a>
        </div>
      </div>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="viewdepartment.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>View Department</p>
                    </a>
                  </li>
  ...
  .search:focus,select:focus{
        ...
        <h4 class="text-bold mb-4" style="font-size:18px;">Add Department</h4>
          <div class="container bg-white py-2">
              <form action="updatedeparment.php?formupdate=<?php echo $row['id'];?>" method="post">
                    ...
                    <input type="date" class="form-control" name="date" value="<?php echo $row['created_date']?>">
                </div>
                <div class="text-center">
                    <button class="btn btn-primary" name="submit">Add New Department</button>
                </div>
            </form>
          </div>
      </div>
