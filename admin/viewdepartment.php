...
if(isset($_GET['del'])){
    ...
    $result = mysqli_query($connect,$sql);
    if($result){
        header('location:viewdepartment.php?sucess');
        exit();
    }  
    else{
...
<tbody>
  ...
  <tr>
    ...
    <td><a href="updatedeparment.php?update=<?php echo $row['id']?>" class="btn btn-success"><i class="fa fa-edit" ></i></a> <a href="viewdepartment.php?del=<?php echo $row['id']?>"class="btn btn-danger"><i class="fa fa-trash"></i></td>
  </tr>
