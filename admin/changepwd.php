...
if(isset($_POST['submit'])){
    ...
    $role = $_GET['role'];
    $pwd = $_POST['pwd'];
    $sql = "update login set pwd = '$pwd' where role = '$role'";
    $result = mysqli_query($connect,$sql);
    if($result){
         ...
         <div class="container">
            ...
            <?php
                if(isset($_GET['success'])){ ?>
                        <p class="bg-success p-2"><i class="fa fa-check"></i> Password Changed Successfully</p>
                        <?php }else if(isset($_GET['error'])) {?>
                            <p class="bg-danger p-2"><i class="fa fa-exclamation"></i> Failed To Change Password</p>
                
                <?php } ?>
            <form class="form-group" action="changepwd.php?role=<?php echo $role?>" method="post">
