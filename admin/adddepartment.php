...
if(isset($_POST['submit'])){
    ...
    $date = $_POST['date'];
    $sql = "INSERT INTO department (dept_name,created_date)VALUES('$dept_name','$date')";
    $result = mysqli_query($connect,$sql);
    if(result){
        header('location:adddepartment.php?success');
        exit();
    }
    else{
        header('location:adddepartment.php?error');
        exit();
    }
}
...
<div class="wrapper">
          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="adddepartment.php" class="nav-link active">
  ...
  .search:focus,select:focus{
   ...
   <?php
            ...
            <p class="bg-success p-2"><i class="fa fa-check"></i> New Department Added Successfully</p>
            <?php } else if(isset($_GET['error'])){?>
                <p class="bg-danger p-2"><i class="fa fa-exclamation"></i> Failed To Add New Department</p>
