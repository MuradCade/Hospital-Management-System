...
if(isset($_POST['submit'])){
    ...
    $pwd = $_POST['pwd'];
    $role = $_POST['role'];
   $sql = "INSERT INTO login (username,pwd,role)VALUES('$username','$pwd','$role')";
   $result = mysqli_query($connect,$sql);
   if($result){
...
<div class="wrapper">
  ...
  .search:focus,select:focus{
   ...
   <?php
            ...
            <p class="bg-success p-2"><i class="fa fa-check"></i> New user Added Successfully</p>
            <?php } else if(isset($_GET['error'])){?>
                <p class="bg-danger p-2"><i class="fa fa-exclamation"></i> Failed To Add New User</p>

    <?php } ?>
        <div class="Container">
          
        <h4 class="text-bold mb-4" style="font-size:18px;">Add New User</h4>
          <div class="container bg-white py-2">
              <form action="adduser.php" method="post">
                    ...
                    <select name="role" class="form-control">
                        ...
                        <option value="labatory">labatory</option>
