      ...
      <div class="container-fluid">
        ...
        <div class="row">
                    <div class="col-lg-4">
                      ...
                      <div class="card mb-4">
                        <form action="updatehospital.php?update=<?php echo $row['id']?>" method="post" enctype='multipart/form-data'>
                        <div class="card-body text-center">
                          <img src="img/<?php echo $row['h_img'];?>" alt="avatar"
                            class="rounded-circle img-fluid" style="width: 150px;">
                          <h5 class="my-3"><?php echo $row['h_name'];?></h5>
                      ...
                      <div class="card mb-4">
                        <div class="card-body">
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <p class="text-muted mb-0"><input type="text" class="form-control" value="<?php echo $row['h_name'];?>" name="h_name"></p>
                            </div>
                          </div>
                          <hr>
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <p class="text-muted mb-0"><input type="text" class="form-control" value="<?php echo $row['h_email'];?>"name="h_email"></p>
                            </div>
                          </div>
                          <hr>
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <p class="text-muted mb-0"><input type="text" class="form-control" value="<?php echo $row['h_phone'];?>"name="h_phone"></p>
                            </div>
                          </div>
                          <hr>
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <p class="text-muted mb-0"><input type="text" class="form-control" value="<?php echo $row['h_mobile'];?>"name="h_mobile"></p>
                            </div>
                          </div>
                          <hr>
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <p class="text-muted mb-0"><input type="text" class="form-control"value="<?php echo $row['h_address'];?>"name="h_address"></p>
                            </div>
                        </div>
