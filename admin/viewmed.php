            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="viewmed.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="changepatientpwd.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Patient Password</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="changedoctorpwd.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Doctor Password</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="changelabpwd.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Labatory Password</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="changepharmacypwd.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Pharmacy Password</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="changereceptionpwd.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View Medication</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<thead>
  <tr>
    ...
    <th class="th-sm">Medication Quantity
    </th>
