...
<div class="wrapper">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="viewpayment.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form action="yearreport.php" method="post">
    ...
    $sql1 = "SELECT * FROM payment WHERE  date_time = '$date'";
 ...
 ?>
     <div class="container">
        <h4>Total = <?php  if(empty($total)){
            echo "Chosing Date Has No Data";
        } else{
            echo '$ '.$total?:"No Data Was Found";
            }?></h4>
     </div>
