...
if(isset($_GET['del'])){
    $del = $_GET['del'];
    $sql = "DELETE FROM login where id = '$del'";
    $result = mysqli_query($connect,$sql);
    if($result){
        ...
        header('location:viewuser.php?error');
        exit();
    }
}
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="viewuser.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>View All Users</p>
                    </a>
                  </li>
...
<tbody>
  ...
  <tr>
    ...
    <td><a href="updateusers.php?update=<?php echo $row['id']?>" class="btn btn-success"><i class="fa fa-edit" ></i></a> <a href="viewuser.php?del=<?php echo $row['id']?>"class="btn btn-danger"><i class="fa fa-trash"></i></td>
  </tr>
