...
<div class="container">
  ...
  <thead>
    <tr>
      ...
      <th class="th-sm">Patient Address
      </th>
      <th class="th-sm">Patient Age
      </th>
      <th class="th-sm">Patient Gender
      </th>
      <th class="th-sm">Patient Ailment
      </th>
      <th class="th-sm">Patient Fee
      </th>
      <th class="th-sm">Eneterd Date
      </th>
      <th class="th-sm">Leaving Date
      </th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $row1['p_fee'];?></td>
      <td><?php echo $row1['p_entered_date'];?></td>
      <td><?php echo $row1['p_leaving_date'];?></td>
    </tr>
 <!-- model start -->
