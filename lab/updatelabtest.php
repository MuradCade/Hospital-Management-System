...
?>
                  <form action="../include/lab/updatelabtest.php?update=<?php echo $row['id']?>" method="post">
                        <div class="container mb-2">
                            <label class="form-label">Patient Name</label>
                            <input type="text" name="p_name" value="<?php echo $row['p_name']?>" class="form-control" placeholder="Enter Patient Name">
                        </div>
                        <div class="container mb-2">
                            <label class="form-label">Patient Phone</label>
                            <input type="text" name="p_phone" value="<?php echo $row['p_phone']?>"class="form-control" placeholder="Enter Patient Phone">
                        </div>
                        <div class="container mb-2">
                            <label class="form-label">Patient Ailment</label>
                            <input type="text" name="p_ailment" class="form-control" value="<?php echo $row['p_ailment']?>"placeholder="Enter Patient Ailment">
                        </div>
                        <div class="container mb-2">
                        ...
                        <div class="container mb-2">
                            ...
                            <textarea  class="form-control" cols="30" rows="5" name="lab_test" placeholder="Enter Laboratory Tests"><?php echo $row['lab_test']?></textarea>
                          </div>
                        <div class="container mb-2">
                            <label class="form-label">Laboratory Test Result</label>
                            <textarea  class="form-control" cols="30" rows="5" name="lab_result" placeholder="Enter Laboratory Tests Result"><?php echo $row['lab_result']?></textarea>
                          </div>
