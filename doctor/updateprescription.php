      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            if(isset($_GET['update'])){
                $testid  = $_GET['update'];
                    $sql = "SELECT * FROM prescription where id = '$testid'";
                    $result = mysqli_query($connect,$sql);
                    $row = mysqli_fetch_assoc($result);
            ?>
          <form action="../include/doctor/updateprescrib.php?updateid=<?php echo $row['id']?>" method="post">
          <div class="container mb-2">
                            <label class="form-label">Patient Name</label>
                            <input type="text" name="p_name" class="form-control"  value="<?php echo $row['p_name']?>"placeholder="Enter Patient Name">
                        </div>
                        <div class="container mb-2">
                        ...
                        <div class="container mb-2">
                            ...
                            <input type="text" name="p_age" class="form-control"  value="<?php echo $row['p_age']?>"placeholder="Enter Patient Age">
                        </div>
                        <div class="container mb-2">
                        ...
                        <div class="container mb-2">
                            ...
                            <input type="text" name="doctor_name" class="form-control"  value="<?php echo $row['doctor_name']?>"placeholder="Enter Doctor Name">
                        </div>
                        <div class="container mb-2">
                            <label class="form-label">Date</label>
                            <input type="date" name="date" class="form-control" value="<?php echo $row['date']?>">
                        </div>
                <div class="text-start ml-2 mt-2 mb-2">
