...
<head>
  ...
  <title>Doctor | View Hospital</title>
  <!-- bootstrap -->
  <!-- CSS only -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View Hospital Information</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                      ...
                      <div class="card mb-4">
                        <div class="card-body">
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <p class="text-muted mb-0"><?php echo $row['h_name'];?></p>
                            </div>
                          </div>
                          <hr>
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <p class="text-muted mb-0"><?php echo $row['h_email'];?></p>
                            </div>
                          </div>
                          <hr>
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <p class="text-muted mb-0"><?php echo $row['h_phone'];?></p>
                            </div>
                          </div>
                          <hr>
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <p class="text-muted mb-0"><?php echo $row['h_mobile'];?></p>
                            </div>
                          </div>
                          <hr>
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <p class="text-muted mb-0"><?php echo $row['h_address'];?></p>
                            </div>
                          </div>
                        </div>
                      </div>
