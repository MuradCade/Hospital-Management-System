          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="addlabtest.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Add Lab Test </p>
                    </a>
                  </li>
        ...
        <div class="row">
            <div class="container">
                ...
                <div class="row">
                  <div class="col-12">
                    <!-- Custom Tabs -->
                  <form action="../include/doctor/addlabtest.php" method="post">
                        ...
                        <div class="container mb-2">
                            ...
                            <input type="text" name="p_phone" class="form-control" placeholder="Enter Patient Id">
                        </div>
                        <div class="container mb-2">
                        ...
                        <div class="container mb-2">
                            ...
                            <textarea  class="form-control" name="labtest" cols="30" rows="5" placeholder="Enter Laboratory Tests"></textarea>
                          </div>
                          <div class="text-center mt-5 mb-3 ">
                            <button class="btn btn-primary" name="submit">Add Laboratory Tests</button>
                          </div>
