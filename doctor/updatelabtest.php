    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            ?>
          <form action="../include/doctor/updatelabtest.php?updateid=<?php echo $row['id']?>" method="post">
          <div class="container mb-2">
                        ...
                        <div class="container mb-2">
                            ...
                            <input type="text" name="p_phone" class="form-control"  value="<?php echo $row['p_phone']?>" placeholder="Enter Patient Id">
                        </div>
                        <div class="container mb-2">
                        ...
                        <div class="container mb-2">
                            ...
                            <textarea  class="form-control" name="labtest" cols="30" rows="5" placeholder="Enter Laboratory Tests"><?php echo $row['lab_test']?></textarea>
                          </div>
