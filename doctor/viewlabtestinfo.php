      ...
      <div class="container-fluid">
        ...
        <div class="modal-body bg-white p-4">
          ...
          <div class="text-break">
            <p>Labtest : <br><?php echo $row['lab_test'];?> <br></p>
          </div>
         <div class="text-break">
           <p>Lab Result : <br><?php echo $row['lab_result'];?></p>
         </div>
         <a href="viewlabtest.php"class="btn btn-secondary" style="color:white!important;"><i class="fa fa-arrow-left"></i> Go Back</a>
        </div>
      </div>
   <?php } ?>
