...
if(isset($_GET['del'])){
  $delid = $_GET['del'];
  $sql = "delete from labtest where id = '$delid'";
  $result = mysqli_query($connect,$sql);
  if($result){
...
<div class="wrapper">
        ...
        <div class="row">
          <div class="container">
            ...
            <div class="container">
              ...
              <a href="addlabtest.php" class="mb-2 btn btn-primary">Add New</a>
  ...
  <thead>
    <tr>
      ...
      <th class="th-sm">Lab Test
      </th>
      <th class="th-sm">Lab Result
      </th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><p style="width:5ch;overflow: hidden;"><?php echo $row['lab_test'];?></p></td>
      <td><a href="viewlabtestinfo.php?viewid=<?php echo $row['id']?>"  class="btn btn-primary"><i class="fa fa-eye"></i></a></td>
      <td><a  href="updatelabtest.php?updateid=<?php echo $row['id']?>" class="btn btn-success">Update</a> &numsp; <a href="viewlabtest.php?del=<?php echo $row['id']?>" class="btn btn-primary">Delete</a></td>
    </tr>
 <!-- model start -->
