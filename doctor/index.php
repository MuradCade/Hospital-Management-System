        ...
        <div class="row">
          <div class="col-2 py-2">
            <div class="card bg-white">
              <span class="text-normal text-start" style="margin-left:10px">Patient</span>
          ...
          <div class="col-2 py-2">
            <div class="card bg-white">
              <span class="text-normal text-start" style="margin-left:10px">Appointment</span>
              <div class="card-footer bg-white">
                <!-- <h4>Menu</h4> -->
          ...
          <div class="col-2 py-2">
            <div class="card bg-white">
              <span class="text-normal text-start" style="margin-left:10px">Active Lab Test</span>
              <div class="card-footer bg-white ">
                <!-- <h4>Menu</h4> -->
