...
if(isset($_POST['submit'])){
    ...
    $sql = "update pharmacy set med_name = '$med_name',med_price = '$med_price',med_quantity = '$med_quantity',expire_date = '$exp_date' where id = '$id'";
    $result = mysqli_query($connect,$sql);
    if($result){
        header('location:viewpharmacy.php');
        exit();
    }
    else{
        header('location:viewpharmacy.php');
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form action="updatemed.php?update=<?php echo $id;?>" method="post">
            <div class="container bg-white p-4">
                
                <div class="form-group">
                    <div class="form-group">
                        <label  class="form-label">Medication Name</label>
                        <input type="text" class="form-control" placeholder="medication Name" name="med_name" value="<?php echo $row1['med_name'];?>">
                    </div>
                    <div class="form-group">
                        <label  class="form-label">Medication Price</label>
                        <input type="text" class="form-control" placeholder="medication Price" name="med_price" value="<?php echo $row1['med_price'];?>">
                    </div>
                    <div class="form-group">
                        <label  class="form-label">Medication Quantity</label>
                        <input type="text" class="form-control" placeholder="medication Quantity" name="med_quantity" value="<?php echo $row1['med_quantity'];?>">
                    </div>
                    <div class="form-group">
                        <label  class="form-label">Expire Date</label>
                        <input type="date" class="form-control"  name="exp_date" value="<?php echo $row1['expire_date'];?>">
                    </div>
                   <div class="text-center">
