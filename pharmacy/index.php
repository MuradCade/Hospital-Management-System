        ...
        <div class="row">
          <div class="col-2 py-2">
            <div class="card bg-white">
              <span class="text-normal text-start" style="margin-left:10px">Number Medication</span>
          ...
          <div class="col-2 py-2">
            <div class="card bg-white">
              <span class="text-normal text-start" style="margin-left:10px">Prescription</span>
              <div class="card-footer bg-white">
                <!-- <h4>Menu</h4> -->
          ...
          <div class="col-2 py-2">
            <div class="card bg-white">
              <span class="text-normal text-start" style="margin-left:10px">Expire Medication</span>
              <div class="card-footer bg-white ">
                <!-- <h4>Menu</h4> -->
