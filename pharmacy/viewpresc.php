...
if(isset($_GET['status'])){
    $status = $_GET['status'];
    $sql = "UPDATE prescription SET status = 'unactive' where id = '$status'";
    $result = mysqli_query($connect,$sql);
    if($result){
        header('location:viewpresc.php?success');
        exit();
    }
    else{
        header('location:viewpresc.php?error');
        exit();
    }
}
            ...
            <a href="index.php" class="nav-link ">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="viewpresc.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
...
<tbody>
  ...
  <tr>
      <td><?php echo $i;?></td>
        ...
        <td><a href="viewprescinfo.php?viewid=<?php echo $row['id'];?>" class="btn btn-primary"><i class="fa fa-eye"></i></a> &numsp; 
<?php
if($row['status'] == 'active'){?>
        <a href="viewpresc.php?status=<?php echo $row['id'];?>" class="btn btn-success"><i class="fa fa-check"></i></a>
<?php } else {
    echo "Compeleted";
}?>
