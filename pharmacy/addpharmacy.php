...
if($med_name == ""){
    header('location:addpharmacy.php?inputerror');
    exit();
}
else if($med_price == ""){
 header('location:addpharmacy.php?inputerror');
    ...
    $sql = "insert into pharmacy(med_name,med_price,med_quantity,expire_date)values('$med_name','$med_price','$med_quantity','$exp_date')";
    $result = mysqli_query($connect,$sql);
    if($result){
        header('location:addpharmacy.php?success');
        exit();
    }
    else{
        header('location:addpharmacy.php?error');
        exit();
    }
}
            ...
            <a href="index.php" class="nav-link ">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="addpharmacy.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Add New </p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="viewpharmacy.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
        ...
        <form action="addpharmacy.php" method="post">
            <div class="container bg-white p-4">
                <?php if(isset($_GET['success'])){?>
                    <p class="bg bg-success p-2">New Item Added Successfully</p>
                    <?php } else if(isset($_GET['error'])){?>
                        <p class="bg bg-danger p-2">Failed To Add New Item</p>
                        <?php }else if(isset($_GET['inputerror'])){?>
                            <p class="bg bg-danger p-2">Empty Field Please Fill The Fields Below</p>
                            
                            <?php } ?>
                <div class="form-group">
                    <div class="form-group">
                        <label  class="form-label">Medication Name</label>
                        <input type="text" class="form-control" placeholder="medication Name" name="med_name">
                    </div>
                    <div class="form-group">
                        <label  class="form-label">Medication Price</label>
                        <input type="text" class="form-control" placeholder="medication Price" name="med_price">
                    </div>
                    <div class="form-group">
                        <label  class="form-label">Medication Quantity</label>
                        <input type="text" class="form-control" placeholder="medication Quantity" name="med_quantity">
                    </div>
                    <div class="form-group">
                   ...
                   <div class="text-center">
                    <button class="btn btn-primary" name="submit">Add New Item</button>
                   </div>
                </div>
            </div>
        </form>
