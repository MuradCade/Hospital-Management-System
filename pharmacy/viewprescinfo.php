    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="modal-body bg-white p-4">
          ...
          <p>Prescription Status : <?php echo $row['status'];?></p>
    
         <a href="viewpresc.php"class="btn btn-secondary" style="color:white!important;"><i class="fa fa-arrow-left"></i> Go Back</a>
        </div>
      </div>
   <?php } ?>
