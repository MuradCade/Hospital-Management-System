...
$uid = $_SESSION['id'];
$sql1 = "SELECT * FROM appointment where uid = '$uid'";
...
if(isset($_GET['del'])){
  $delid = $_GET['del'];
  $sql = "delete from appointment where id = '$delid'";
  $result = mysqli_query($connect,$sql);
  if($result){
...
<div class="wrapper">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="viewappointmentinfo.php?viewid=<?php echo $row1['id']?>" class="btn btn-primary"><i class="fa fa-eye"></i></a></td>
      <td><a href="updateappointmentinfo.php?update=<?php echo $row1['id']?>" class="btn btn-success">Update</a> &numsp; <a href="viewappointment.php?del=<?php echo $row1['id']?>" class="btn btn-danger">Delete</a></td>
    </tr>
 <!-- model start -->
