        ...
        <?php
          if(isset($_GET['success'])){?>
            ...
            <?php     }else if(isset($_GET['error'])){?>
              ...
              <?php }else if(isset($_GET['formerror'])){?>
                <p class='bg-danger text-white p-2'><i class='fa fa-exclamation'></i> Empty Form Field Please Fill The Form Fields</p>
    ...
    <?php }
          ?>
            <div class="container">
                ...
                <form action="../include/patient/addappointment.php"method="post"class="bg-white p-4">
