    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="modal-body bg-white p-4">
          <p>Patient Fullname : <?php echo $row['p_fname'];?></p>
          <p>Patient Phone : <?php echo $row['p_phone'];?></p>
          <p>Doctor Name : <?php echo $row['doctor_name'];?></p>
          <p>Department Name : <?php echo $row['department_name'];?></p>
          <p>Date : <?php echo $row['date_time'];?></p>
          
        
         <a href="viewappointment.php"class="btn btn-secondary" style="color:white!important;"><i class="fa fa-arrow-left"></i> Go Back</a>
        </div>
      </div>
   <?php } ?>
