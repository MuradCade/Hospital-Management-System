    ...
    <?php }
          ?>
                            <div class="container p-2"
                                ...
                                <input type="text" placeholder="Change Username" value="<?php if(isset($_SESSION['username'])) echo $_SESSION['username']; ?>"class="form-control" name="username">
                            </div>
                            <div class="container p-2">
                ...
                <div class="card">
                    ...
                    <h4 class="text-bold mb-2" style="font-size: 16px;text-transform: uppercase;">Change Password</h4>
                        <div class="form-group bg-white">
                            ...
                            <div class="container p-2">
                                <label class="form-label" style="font-weight:normal !important;">Your Id</label>
                                <input type="text" value="090" class="form-control" readonly>
                            </div>
                            <div class="container p-2 text-center">
                                <button class="btn btn-primary">Change Password</button>
                            </div>
